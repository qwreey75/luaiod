...
return function (main, ...)
  ...
  -- load custom libs
  require("bundle:/deps/table.dump.lua")
  _G.promise = require("bundle:/deps/promise")
  _G.logger = require("bundle:/deps/logger")
  _G.json = require("bundle:/deps/json.lua")
  _G.profiler = require("bundle:/deps/profiler")
  _G.info = logger.info;_G.warn = logger.warn
  _G.infof = logger.infof;_G.warnf = logger.warnf
  _G.tester = require("bundle:/deps/tester")
